function buildMetadata(sample) {
  ...
  d3.json(metadataURL).then(function (myData) {
...
function buildCharts(sample) {
  ...
  d3.json(chartsURL).then(function (myData) {
    ...
    var data = [{
      values: myData.sample_values.slice(0, 10),
      labels: myData.otu_ids.slice(0, 10),
      hovertext: myData.otu_labels.slice(0, 10),
      type: 'pie',
    }];
